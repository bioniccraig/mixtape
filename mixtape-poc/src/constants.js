...
export const TAPE_SKINS = [
  ...
  { id: 'cassette1', name: 'Cassette 1', body: '/skins/cassette1.png', reelImgs: [], reels: [], rad: 0, label: { x: 0.52, y: 0.25, w: 0.55, color: '#26262b' } },
  { id: 'cassette2', name: 'Cassette 2', body: '/skins/cassette2.png', reelImgs: [], reels: [], rad: 0, label: { x: 0.52, y: 0.25, w: 0.55, color: '#26262b' } },
  { id: 'cassette3', name: 'Cassette 3', body: '/skins/cassette3.png', reelImgs: [], reels: [], rad: 0, label: { x: 0.52, y: 0.25, w: 0.55, color: '#26262b' } },
